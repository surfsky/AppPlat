...
namespace App.Components
{
    ...
    public static class HttpHelper
    {
        ...
        static string BuildQueryString(this Dictionary<string, string> data)
        {
        ...
        public static string Post(string url, string queryString, Encoding encoding = null, string contentType = null, CookieContainer cookieContainer = null)
        {
            ...
            byte[] bytes = queryString.IsNullOrEmpty() ? new byte[0] : encoding.GetBytes(queryString);
        ...
        {
            return Post(url, BuildQueryString(data), encoding, contentType, cookieContainer);
        }
        ...
        public static Image GetServerOrNetworkImage(string url)
        {
            ...
            if (url.StartsWith("~/") || url.StartsWith(".") || url.StartsWith("/"))
                img = Image.FromFile(server.MapPath(url));
        ...
        public static void WriteImage(Image img, string name="")
        {
