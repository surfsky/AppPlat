...
namespace App.Schedule
{
    ...
    public class Task : ITaskRunner
    {
        ...
        public TaskStatus Status { get; set; } = TaskStatus.Success;
        ...
        public List<Task> Dependency { get; set; } = new List<Task>();
        ...
        public Task(string name, string schedule, DateSpan interval, DateSpan failure=null)
        {
            this.Name = name;
        ...
        [JsonIgnore] public ITaskRunner TaskRunner
        {
            get
            {
                if (_runner == null)
                {
                    ...
                    _runner = assembly.CreateInstance(this.Runner.FullName) as ITaskRunner;
                }
                return _runner;
            }
        }
