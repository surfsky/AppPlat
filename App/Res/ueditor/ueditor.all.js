...
var utils = UE.utils = {
    ...
    /**
     * 动态加载文件到doc中，并依据obj来设置参数，加载成功后执行回调函数fn
     * @name loadFile
...
var domUtils = dom.domUtils = {
    ...
    /**
     * 比较节点nodeA与节点nodeB是否具有相同的标签名、参数名以及参数值
     * @name  isSameElement
    ...
    isSameElement:function (nodeA, nodeB) {
        ...
        // 有可能attrB的参数包含了attrA的参数之外还有自己的参数
        if (ie) {
    ...
    /**
     * 删除节点node上的参数attrNames，attrNames为参数名称数组
 ...
 * @desc Range范围实现类，本类是UEditor底层核心类，统一w3cRange和ieRange之间的差异，包括接口和参数
 */
(function () {
    var guid = 0,
    ...
    Range.prototype = {
         ...
         * @grammar range.applyInlineStyle(tagName,attrs)  =>  Range    //attrs为参数json对象
         * @desc
...
//                });
         ...
         * @desc
         * 后台取得数据得键值使用你容器上得''name''参数，如果没有就使用参数传入的''textarea''
         * @example
         * editor.sync();
...
UE.plugins['autotypeset'] = function(){
    ...
    this.setOpt({'autotypeset':{
        mergeEmptyline : true,          //合并空行
            ...
            textAlign : "left",             //段落的排版方式，可以是 left,right,center,justify 去掉这个参数表示不执行排版
            imageBlockLine : 'center',      //图片的浮动方式，独占一行剧中,左右浮动，默认: center,left,right,none 去掉这个参数表示不执行排版
...
(function () {
    ...
    /**
     * 获取单元格或者单元格组的“对齐”状态。 如果当前的检测对象是一个单元格组， 只有在满足所有单元格的 水平和竖直 对齐参数都相同的
    ...
    UETable.prototype = {
        ...
        mergeRange:function () {
            ...
            // 修改左上角Cell的rowSpan和colSpan，并调整宽度参数设置
