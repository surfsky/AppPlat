<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeptUserNew.aspx.cs"  Inherits="App.Admin.DeptUserNew" %>
...
<body>
    ...
    <f:Panel ID="Panel1" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="0px" Layout="Fit">
        <Items>
            <f:GridPro ID="Grid1" runat="server"  AutoCreateFields="false">
                <Toolbars>
                    <f:Toolbar ID="Toolbar1" runat="server">
                        <Items>
                            ...
                            <f:TwinTriggerBoxPro ID="ttbSearchMessage" Width="160px" runat="server" ShowLabel="false"
                                EmptyText="搜索用户名" OnTriggerClick="ttbSearchMessage_TriggerClick" />
                        </Items>
                    </f:Toolbar>
                </Toolbars>
                <Columns>
