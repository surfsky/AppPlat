<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleUsers.aspx.cs" Inherits="App.Admin.RoleUsers" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Window ID="Window1" CloseAction="Hide" runat="server" IsModal="true" Hidden="true" Target="Top" EnableResize="true" EnableMaximize="true" EnableIFrame="true" IFrameUrl="about:blank" Width="650px" Height="450px" 
