<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TitleUserNew.aspx.cs" Inherits="App.Admin.TitleUserNew" %>
                ...
                <Toolbars>
                    <f:Toolbar ID="Toolbar1" runat="server">
                        <Items>
                            ...
                            <f:TwinTriggerBoxPro ID="ttbSearchMessage" Width="180px" runat="server" ShowLabel="false"
                                EmptyText="在用户名称中搜索" 
